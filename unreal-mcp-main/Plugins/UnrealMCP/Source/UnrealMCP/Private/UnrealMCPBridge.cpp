...
void UUnrealMCPBridge::StopServer()
{
    ...
    // Close sockets first to unblock the thread
...
FString UUnrealMCPBridge::ExecuteCommand(const FString& CommandType, const TSharedPtr<FJsonObject>& Params)
{
    ...
    // Queue execution on Game Thread outside of TaskGraph to avoid recursion assertion during asset imports
    FTSTicker::GetCoreTicker().AddTicker(FTickerDelegate::CreateLambda([this, CommandType, Params, Promise](float DeltaTime) -> bool
    {
